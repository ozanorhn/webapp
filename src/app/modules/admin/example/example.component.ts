    ...
    private _initializeData(): void {
        this.data = {
            conversions: {
                ...
                series: [
                    {
                        data: [45, 52, 48, 61, 58, 72, 68, 78, 82, 88],
                    },
                ],
                labels: [
                    'Day 1',
            ...
            impressions: {
                ...
                series: [
                    {
                        data: [
                            945, 1252, 1148, 1261, 1358, 1372, 1368, 1378, 1382,
                            1388,
                        ],
                    },
                ],
            ...
            visitorsVsPageViews: {
                ...
                series: [
                    {
                        name: 'Visitors',
                        data: [2500, 2800, 2450, 2950, 3200, 3100, 2850],
                    },
                    {
                        name: 'Page Views',
                        data: [3500, 3800, 3450, 3950, 4200, 4100, 3850],
                    },
                ],
            },
            newVsReturning: {
            ...
            age: {
                ...
                series: [15, 35, 28, 12, 7, 3],
            },
            language: {
                uniqueVisitors: 5240,
                labels: ['English', 'German', 'French', 'Spanish', 'Other'],
    ...
    private _prepareChartData(): void {
        ...
        this.chartVisitors = {
            ...
            series: [
                ...
                {
                    name: 'Last Year',
                    data: [2400, 2700, 2300, 2800, 3100, 3000, 2750],
                },
            ],
            stroke: {
                width: 2,
